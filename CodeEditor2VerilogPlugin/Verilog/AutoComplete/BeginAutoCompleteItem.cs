...
namespace pluginVerilog.Verilog.AutoComplete
{
    ...
    {
        public BeginAutoCompleteItem() : base("begin", CodeDrawStyle.ColorIndex(CodeDrawStyle.ColorType.Keyword), Plugin.ThemeColor, "CodeEditor2/Assets/Icons/screwdriver.svg")
        {
        }
