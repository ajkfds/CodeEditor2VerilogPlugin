...
namespace pluginVerilog.Data.VerilogCommon
{
    ...
    //    public static List<CodeEditor2.CodeEditor.PopupItem> GetPopupItems(IVerilogRelatedFile item, Verilog.ParsedDocument parsedDocument, ulong version, int index)
    //    {
